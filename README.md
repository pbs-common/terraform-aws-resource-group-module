...
```hcl
github.com/pbs/terraform-aws-resource-group-module?ref=1.0.0
```
...
module "resource_group" {
  source = "github.com/pbs/terraform-aws-resource-group-module?ref=1.0.0"
...
| <a name="input_owner"></a> [owner](#input\_owner) | Tag used to indicate resource/project owner | `string` | n/a | yes |
